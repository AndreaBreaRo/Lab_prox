...
contract("ViCOINSale", () => {
  ...
  it("Compra de 5 ViCOINs llevada a cabo correctamente", async () => {
    this.ViCSale.buyViCOINS("5000000000000000000", {
    ...
    assert.equal(balance.toString(), "19995000000000000000000");
    assert.equal(balance2.toString(), web3.utils.toWei("5", "ether"));
